...
public class Encoder extends ProtocolEncoderAdapter {
    ...
    public void encode(IoSession session, Object message, ProtocolEncoderOutput out) throws Exception {
         ...
         * 数据传输格式
         * buffer
         * requestId:length 2字节
         * requestId:内容 length字节
         * 
         * className:length 2字节
         * className 内容 length字节
         * 
         * methodName length 2字节
         * mehtodName 内容 length字节
         *
         * args length 2字节
         * args 内容 length字节
         *
        ...
        byte[] versionBytes = msg.getVersion().getBytes(this.charset);
		 ...
		 buffer.flip();
		 System.out.println("send limit:"+buffer.limit());
